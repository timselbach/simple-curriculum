...
from simple_project.curriculum.config import TRAINING_STRATEGY
from simple_project.curriculum.strategies.base import TrainingStrategy
from simple_project.curriculum.training.two_phase_training import train_phase_competence
...
class CompetenceTraining(TrainingStrategy):
    def train(self, model, device, tokenizer, dataset,config, val_dataset):
        ...
        # Extract curriculum-specific configuration
        curriculum_config = TRAINING_STRATEGY.get('curriculum', {})
        ...
        train_phase_competence(
            ...
            c0=c0,
            phase_desc="Curriculum-Based Training",
            val_dataset=val_dataset,
            max_t_steps=max_t_steps
        )

        print("Curriculum-Based Training completed.")
